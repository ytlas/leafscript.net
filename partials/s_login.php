...
if(isset($_POST['userName'])&&isset($_POST['userPassword'])&&!Misc::li()){
	...
	if(User::exists($userName)){
	    ...
	    $result=$con->query("SELECT id,name,password,groupName
				 FROM user
				 WHERE name='$userName'");
		...
		if($row['groupName']!='banned'){
		    ...
		    echo "<p>Your account is not activated yet. Please check the inbox of the email you provided and click the link to activate your account.</p>";
		    $flag=true;
		}
	    }
	}
