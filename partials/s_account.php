...
<form method="post" action="/login">
    <input type="text" placeholder="Username" name="userName" pattern="[a-zA-Z0-9_]{3,16}"><br>
...
<form method="post" action="/register">
    ...
    <input type="password" placeholder="Password" name="userPassword" pattern="[^.*$]{4,32}"><br>
